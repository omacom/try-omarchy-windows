...
- The guest image now includes fcitx5, so Omarchy's input method service no longer fails and restarts every two seconds for the whole session, and the CapsLock compose sequences work.
