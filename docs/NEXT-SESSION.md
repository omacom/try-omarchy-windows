...
- [Approved Windows app bridge #160](https://github.com/omacom/try-omarchy-windows/issues/160): [PR #169](https://github.com/omacom/try-omarchy-windows/pull/169) implements phase 1 with a host allowlist, guest launcher entries and fullscreen return. A Notepad round trip and revocation passed on the AMD laptop; the full guest image built and passed its boot smoke. Read the [physical record](evidence/WINDOWS-APP-BRIDGE-2026-09-23.md). It is not in public `v0.1.0`; embedded windows remain a separate milestone.
